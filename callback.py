...
def conta_keyword(string, app):
    ...
    # stampa il numero di parole chiave trovate e la percentuale di parole chiave trovate per ogni linguaggio
    print("--Numero di parole chiave trovate per linguaggio")
    for ling, num_keywords in contatore.items():
        percentuale = num_keywords / num_words * 100
        print(f"{ling}: {num_keywords} ({percentuale:.2f}%)")
